 ...
 */
allowed_extensions: string[] | null, } } | { "ListAllPeers": { request_id: string, cid: bigint, } } | { "ListRegisteredPeers": { request_id: string, cid: bigint, } } | { "PeerConnect": { request_id: string, cid: bigint, peer_cid: bigint, udp_mode: UdpMode, session_security_settings: SessionSecuritySettings, peer_session_password: PreSharedKey | null, 
/**
 * TURN relay servers for this attempt. Absent means no relay. Both peers must send
 * one for the relay to be used.
 */
turn?: PeerTurnConfig | null, } } | { "PeerDisconnect": { request_id: string, cid: bigint, peer_cid: bigint, } } | { "PeerConnectAccept": { request_id: string, 
/**
 ...
 */
accept: boolean, udp_mode: UdpMode, session_security_settings: SessionSecuritySettings, peer_session_password: PreSharedKey | null, 
/**
